...
class Qwen2AudioForConditionalGeneration(Qwen2AudioPreTrainedModel):
    ...
    #when instance.padding_side=value call setter
    @padding_side.setter
    ...
    def _merge_input_ids_with_audio_features(
        ...
        # if rank==0 or rank== -1:
        #     print(f'final_attention_mask:{final_attention_mask.dtype}')
        #     print(f'audio_to_overwrite:{audio_to_overwrite.dtype}')
        #     print(f'attention_mask:{attention_mask.dtype}')
        # final_attention_mask=final_attention_mask.long()
        # audio_to_overwrite=audio_to_overwrite.bool()
        # if rank==0 or rank== -1:
        #     print(f'final_attention_mask_after:{final_attention_mask.dtype}')
        #     print(f'audio_to_overwrite_after:{audio_to_overwrite.dtype}')
